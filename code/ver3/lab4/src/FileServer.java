...
public class FileServer {
  ...
  public static void main(String[] args) throws IOException {
    ...
    if (args.length !=2 ) {
      System.out.println("Usage: java -classpath lib/zookeeper-3.3.2.jar:lib/log4j-1.2.15.jar:. FileServer zkServer:serverPort dictionary_file");
      return;
    }
    ...
    FileServer fs = new FileServer(args[0], myHost+":"+myPort, args[1]);
  ...
  public FileServer(String zkHost, String myHost, String dictFile) throws IOException {
    this.myHost = myHost;
    this.dictionaryPath = dictFile;
